										...
										<div class="item-views catalog sections">
											<div class="items row margin0 row_block flexbox nmac">
												...
												while (have_posts()):
													...
													// the_post_navigation(
													// 	array(
													// 		'prev_text' => '<span class="nav-subtitle">' . esc_html__( 'Previous:', 'diak' ) . '</span> <span class="nav-title">%title</span>',
													// 		'next_text' => '<span class="nav-subtitle">' . esc_html__( 'Next:', 'diak' ) . '</span> <span class="nav-title">%title</span>',
													// 	)
													// );
